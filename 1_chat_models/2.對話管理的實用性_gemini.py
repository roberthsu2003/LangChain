...
def demonstrate_with_conversation_memory():
    ...
    conversation_messages.append(AIMessage(content=result1.content))
    print(f"學生：請解釋什麼是質數？")
    print(f"AI老師：{result1.content}")
    print()
    ...
    conversation_messages.append(AIMessage(content=result2.content))
    print(f"學生：請給我一個例子")
    print(f"AI老師：{result2.content}")
    print()
    ...
    conversation_messages.append(AIMessage(content=result3.content))
    print(f"學生：那合數呢？")
    print(f"AI老師：{result3.content}")
    print()
...
def demonstrate_conversation_flow():
    ...
    for i, question in enumerate(learning_conversation, 1):
        ...
        learning_messages.append(AIMessage(content=result.content))
        print(f"學生：{question}")
        print(f"AI老師：{result.content}")
        print()
...
def demonstrate_memory_benefits():
    ...
    memory_messages.append(AIMessage(content=result1.content))
    print(f"學生：什麼是圓周率？")
    print(f"AI老師：{result1.content}")
    print()
    ...
    memory_messages.append(AIMessage(content=result2.content))
    print(f"學生：它的值是多少？")
    print(f"AI老師：{result2.content}")
    print()
    ...
    memory_messages.append(AIMessage(content=result3.content))
