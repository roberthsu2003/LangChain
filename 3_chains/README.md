...
| **2** | **擴展鏈** | ⭐⭐ | 自定義處理 | RunnableLambda 的使用 |
| **3** | **並行鏈** | ⭐⭐⭐ | 效率優化 | RunnableParallel 並行執行 |
| **4** | **分支鏈** | ⭐⭐⭐ | 智能路由 | RunnableBranch 條件判斷 |
| **5** | **內部運作** | ⭐⭐⭐⭐ | 底層機制 | RunnableSequence 手動組合 |
...
## 5️⃣ 鏈的內部運作 (Chains Under the Hood) - 深入理解
