...
| **第8章** | [Agents & Tools](./5_agents_and_tools) | 🤖 智能代理與工具 | Agent 類型（ReAct、Structured Chat）、工具建立（Constructor、Decorator、BaseTool）、多 Agent 協作、實戰案例（研究助手、客服系統） |
...
5. **第6章** → 理解鏈的概念
6. **第7章** → RAG應用（檢索增強生成）
7. **第8章** → 智能代理開發（Agent 與 Tools）

### 進階開發者快速通道
- 已熟悉基礎？直接跳到 **第7章 RAG** 學習檢索增強生成
- 想建立智能助手？前往 **第8章 Agents & Tools** 查看實戰案例
- 需要快速原型？使用 **第2章 Gradio** 建立互動介面
---
